...
public class CompanyRatingController {
    ...
    public CompanyRating getRating(@RequestParam(value = "companyId") String companyId,@RequestParam(value = "email") String email){
        return companyRatingService.getRating(companyId,email);
    }
